...
public class ItemMassacre extends ItemSword {
    ...
    public void addInformation(ItemStack stack, EntityPlayer playerIn, List toolTip, boolean advanced) {
		toolTip.add(EnumChatFormatting.DARK_PURPLE + "\"Strengthen your resolve with");
		toolTip.add(EnumChatFormatting.DARK_PURPLE + "the blood of your enemies.\"");
		toolTip.add(" ");
		toolTip.add(EnumChatFormatting.GOLD + "35% chance on hit:");
		toolTip.add(EnumChatFormatting.GREEN + "Self - Resistance vs All for 5 seconds.");
		toolTip.add(EnumChatFormatting.GREEN + "Self - Movement Speed for 3 seconds.");
	}
