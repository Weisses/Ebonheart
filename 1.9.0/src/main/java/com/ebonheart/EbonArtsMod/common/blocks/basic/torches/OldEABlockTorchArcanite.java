...
public class OldEABlockTorchArcanite extends Block {
	    ...
	    public OldEABlockTorchArcanite(String unlocalizedName)
	    {
	    ...
	    public int getMetaFromState(IBlockState state)
	    {
	        ...
	        switch (OldEABlockTorchArcanite.SwitchEnumFacing.FACING_LOOKUP[((EnumFacing)state.getValue(FACING)).ordinal()])
	        {
	            case 1:
	                i = b0 | 1;
	                break;
