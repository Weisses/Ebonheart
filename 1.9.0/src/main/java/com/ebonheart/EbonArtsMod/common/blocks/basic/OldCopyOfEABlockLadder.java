...
public class OldCopyOfEABlockLadder extends BlockLadder
{
    public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);
    
    public OldCopyOfEABlockLadder(String unlocalizedName)
    {
        super();
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess worldIn, BlockPos pos)
    {
        ...
        if (iblockstate.getBlock() == this)
        {
            ...
            switch (OldCopyOfEABlockLadder.SwitchEnumFacing.FACING_LOOKUP[((EnumFacing)iblockstate.getValue(FACING)).ordinal()])
            {
                case 1:
