...
public class OldCopyOfEABlockFence extends Block {
	...
	public OldCopyOfEABlockFence(String unlocalizedName) 
	{
		super(Material.rock);
    ...
    public boolean canConnectTo(IBlockAccess worldIn, BlockPos pos)
    {
        ...
        return block == Blocks.barrier ? false : 
        	(
        			(!(block instanceof BlockFence || block instanceof OldCopyOfEABlockFence) || block.getMaterial() != this.blockMaterial) 
        			
        			&&
        			
        			!(block instanceof EABlockFenceGate || block instanceof BlockFenceGate) 
        			
        			? 
        			
        			(block.getMaterial().isOpaque() && block.isFullCube() ? block.getMaterial() != Material.gourd : false)
    ...
    public boolean canPlaceTorchOnTop(IBlockAccess world, BlockPos pos)
    {
        ...
        {
            return this instanceof OldCopyOfEABlockFence;
        }
    }
}
