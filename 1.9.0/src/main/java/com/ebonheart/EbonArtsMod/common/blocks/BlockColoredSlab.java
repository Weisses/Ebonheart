 ...
 * @author Choonster
 */
public abstract class BlockColoredSlab extends BlockSlabEA<EnumDyeColor, BlockColoredSlab.EnumColourGroup, BlockColoredSlab> {
	 ...
	 */
	public BlockColoredSlab(Material material, EnumColourGroup colourGroup, SlabGroup<EnumDyeColor, EnumColourGroup, BlockColoredSlab> slabGroup) {
	...
	public static class ColouredSlabGroup {
		public final SlabGroup<EnumDyeColor, EnumColourGroup, BlockColoredSlab> low;
		public final SlabGroup<EnumDyeColor, EnumColourGroup, BlockColoredSlab> high;
		 ...
		 */
		private SlabGroup<EnumDyeColor, EnumColourGroup, BlockColoredSlab> createGroup(String groupName, Material material, EnumColourGroup colourGroup) {
			return new SlabGroup<EnumDyeColor, EnumColourGroup, BlockColoredSlab>(groupName, material, colourGroup) {
				@Override
				public BlockColoredSlab createSlab(final Material material, final boolean isDouble, final EnumColourGroup colourGroup) {
					return new BlockColoredSlab(material, colourGroup, this) {
						@Override
		 ...
		 * @return The slab group
		 */
		public SlabGroup<EnumDyeColor, EnumColourGroup, BlockColoredSlab> getSlabGroupByColourGroup(EnumColourGroup colourGroup) {
