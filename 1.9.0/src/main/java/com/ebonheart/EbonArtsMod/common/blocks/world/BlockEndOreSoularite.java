...
public class BlockEndOreSoularite extends Block {
	
	public BlockEndOreSoularite(int harvestlevel, float hardness) 
	{
		super(Material.rock);
		BlockHelper.setBlockName(this, "ore/soularite_ore_end");
