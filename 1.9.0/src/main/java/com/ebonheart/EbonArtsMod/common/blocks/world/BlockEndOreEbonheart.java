...
public class BlockEndOreEbonheart extends Block {
	
	public BlockEndOreEbonheart(int harvestlevel, float hardness) 
	{
		super(Material.rock);
		BlockHelper.setBlockName(this, "ore/ebonheart_ore_end");
