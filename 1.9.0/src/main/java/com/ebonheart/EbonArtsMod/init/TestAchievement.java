...
public class TestAchievement extends AchievementsEA {
    ...
    {
    	mine_draconium_ore = addAchievement(MINE_DRACONIUM_ORE, "mine_draconium_ore", -1, -1, new ItemStack(InitBlocksEA.draconium_ore), (Achievement)null);

    	//mine_draconium_ore = addAchievement(MINE_DRACONIUM_ORE, "ea", -1, -1, InitBlocksEA.draconium_ore, (Achievement)null);//.func_180788_c();
		glowing_disc = addAchievement(GLOWING_DISC, "glowing_disc", -3, -2, new ItemStack(InitItemsEA.glowing_disc), (Achievement)mine_draconium_ore);//.func_180788_c();
		...
		necrosis = addAchievement(NECROSIS, "necrosis", -5, 1, new ItemStack(InitItemsEA.necrosis), (Achievement)mine_necrocite_ore);//.func_180788_c();
		...
		consecration = addAchievement(CONSECRATION, "consecration", 7, 1, new ItemStack(InitItemsEA.consecration), (Achievement)mine_soularite_ore);//.func_180788_c();
		...
		massacre = addAchievement(MASSACRE, "massacre", -1, 5, new ItemStack(InitItemsEA.massacre), (Achievement)empowered_blade).setSpecial();//.func_180788_c();
		blazefury = addAchievement(BLAZEFURY, "blazefury", 3, 3, new ItemStack(InitItemsEA.blazefury), (Achievement)empowered_blade).setSpecial();//.func_180788_c();
		despair = addAchievement(DESPAIR, "despair", 3, 4, new ItemStack(InitItemsEA.despair), (Achievement)empowered_blade).setSpecial();//.func_180788_c();
