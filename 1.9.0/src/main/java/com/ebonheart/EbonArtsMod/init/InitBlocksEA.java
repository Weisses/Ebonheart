...
import com.ebonheart.EbonArtsMod.common.blocks.basic.BlockCobbleMystic;
...
import com.ebonheart.EbonArtsMod.common.blocks.basic.torches.OldEABlockTorchArcanite;
...
public class InitBlocksEA extends BlocksEA {
	...
	public static void preInit()
	{
		...
		ebonheart_ore = new BlockOreEbonheart(3, 30f);
		...
		draconium_wall = new EABlockWall("wall/draconium_wall", draconium_block).setHardness(5.0F).setResistance(4.0F);
		velious_wall = new EABlockWall("wall/velious_wall", velious_block).setHardness(5.0F).setResistance(15.0F);
		arcanite_wall = new EABlockWall("wall/arcanite_wall", arcanite_block).setHardness(5.0F).setResistance(30.0F);
		katcheen_wall = new EABlockWall("wall/katcheen_wall", katcheen_block).setHardness(5.0F).setResistance(2000.0F);
		necrocite_wall = new EABlockWall("wall/necrocite_wall", necrocite_block).setHardness(5.0F).setResistance(45.0F);
		soularite_wall = new EABlockWall("wall/soularite_wall", soularite_block).setHardness(5.0F).setResistance(45.0F);
		ebonheart_wall = new EABlockWall("wall/ebonheart_wall", ebonheart_block).setHardness(5.0F).setResistance(2000.0F);
		obsidian_wall = new EABlockWall("wall/obsidian_wall", obsidian_block).setHardness(5.0F).setResistance(2000.0F);
		glowstone_wall = new EABlockWall("wall/glowstone_wall", glowstone_block).setHardness(5.0F).setResistance(45.0F).setLightLevel(1.0f);
		...
		cobble_mystic_block_normal = new BlockCobbleMystic().setHardness(5.0F).setResistance(1000.0F);
		mystic_block_normal = new BlockMystic().setHardness(5.0F).setResistance(1000.0F);
	...
	public static void register()
	{
		...
		GameRegistry.registerBlock(cobble_mystic_block = new EABlockMeta("gem/mystic/cobble_mystic_block", Material.rock), ItemBlockMeta.class, "gem/mystic/cobble_mystic_block");
