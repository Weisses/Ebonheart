...
public class ChestGenHooksEA {
	    ...
	    private static final HashMap<String, ChestGenHooksEA> chestInfo = new HashMap<String, ChestGenHooksEA>();
	    ...
	    {
	        chestInfo.put(category, new ChestGenHooksEA(category, items, min, max));
	    }

	    static void addDungeonLoot(ChestGenHooksEA dungeon, ItemStack item, int weight, int min, int max)
	    {
	     ...
	     */
	    public static ChestGenHooksEA getInfo(String category)
	    {
	        if (!chestInfo.containsKey(category))
	        {
	            chestInfo.put(category, new ChestGenHooksEA(category));
	        }
	    ...
	    public ChestGenHooksEA(String category)
	    {
	        this.category = category;
	    }

	    public ChestGenHooksEA(String category, List<WeightedRandomChestContent> items, int min, int max)
	    {
	        this(category);
	    ...
	    public ItemStack getOneItem(Random rand)
	    {
	        ...
	        ItemStack[] stacks = ChestGenHooksEA.generateStacks(rand, item.theItemId, item.minStackSize, item.maxStackSize);
