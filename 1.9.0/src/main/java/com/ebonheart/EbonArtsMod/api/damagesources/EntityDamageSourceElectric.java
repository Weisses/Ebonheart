...
public class EntityDamageSourceElectric extends EntityDamageSourceIndirect {
	...
	public ITextComponent getDeathMessage(EntityLivingBase entityLivingBaseIn)
    {
        ...
        String s1 = s + ".item";
        return itemstack != null && itemstack.hasDisplayName() && I18n.canTranslate(s1) ? new TextComponentTranslation(s1, new Object[] {entityLivingBaseIn.getDisplayName(), itextcomponent, itemstack.getChatComponent()}): new TextComponentTranslation(s, new Object[] {entityLivingBaseIn.getDisplayName(), itextcomponent});
    }
