...
public class EntityCandleFX extends EntityFX
{
    ...
    public EntityCandleFX(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn)
    {
    ...
    public float getBrightness(float partialTicks)
    {
        float f = ((float)this.particleAge + partialTicks) / (float)this.particleMaxAge;
        f = MathHelper.clamp_float(f, 0.0F, 1.0F);
        float f1 = super.getBrightnessForRender(particleMaxAge);
        return f1 * f + (1.0F - f);
    }
    ...
    public static class Factory implements IParticleFactory
        {
            ...
            {
                return new EntityCandleFX(worldIn, xCoordIn, yCoordIn, zCoordIn, xSpeedIn, ySpeedIn, zSpeedIn);
            }
        }
}