...
public abstract class EABlockSlabDraconium extends BlockSlab
{
	...
	public static final PropertyEnum<EABlockSlabDraconium.EnumType> VARIANT = PropertyEnum.<EABlockSlabDraconium.EnumType>create("variant", EABlockSlabDraconium.EnumType.class);
    ...
    {
        return new ItemStack(InitBlocksEA.draconium_slab, 1, ((EABlockSlabDraconium.EnumType)state.getValue(VARIANT)).getMetadata());
    }
    ...
    {
        return EABlockSlabDraconium.EnumType.byMetadata(stack.getMetadata() & 
        		//7
        		0);
    }
    ...
    public void getSubBlocks(Item itemIn, CreativeTabs tab, List<ItemStack> list)
    {
        ...
        {
            for (EABlockSlabDraconium.EnumType EABlockSlabDraconium$enumtype : EABlockSlabDraconium.EnumType.values())
            {
    ...
    {
        IBlockState iblockstate = this.getDefaultState().withProperty(VARIANT, EABlockSlabDraconium.EnumType.byMetadata(meta & 
        		//7
        		0));
        ...
        {
            iblockstate = iblockstate.withProperty(HALF, (meta & 8) == 0 ? EABlockSlabDraconium.EnumBlockHalf.BOTTOM : EABlockSlabDraconium.EnumBlockHalf.TOP);
        }
    ...
    public static enum EnumType implements IStringSerializable
    {
        ...
        private static final EABlockSlabDraconium.EnumType[] META_LOOKUP = new EABlockSlabDraconium.EnumType[values().length];
