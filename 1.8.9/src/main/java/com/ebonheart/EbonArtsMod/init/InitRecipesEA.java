...
public class InitRecipesEA {
	...
	/**	
		...
		if(!EbonArtsConfiguration.armorWeaponDifficult)
		{
			...
			GameRegistry.addShapedRecipe(new ItemStack(InitItemsEA.vengeance_chestplate), new Object[]{"N N", "NCN", "EEE", 'N', InitItemsEA.dense_necrocite, 'E', InitItemsEA.enchanted_ebonheart, 'C', Items.nether_star});
		...
		else
		{
			...
			GameRegistry.addShapedRecipe(new ItemStack(InitItemsEA.vengeance_chestplate), new Object[]{"N N", "NCN", "EEE", 'N', InitItemsEA.necrocite, 'E', InitItemsEA.enchanted_ebonheart, 'C', Items.nether_star});
	...
	public static void initShapelessRecipe()
	{
		...
		GameRegistry.addShapelessRecipe(new ItemStack(InitItemsEA.dragon_fruit), InitItemsEA.ebonheart, new ItemStack(Items.nether_wart));
