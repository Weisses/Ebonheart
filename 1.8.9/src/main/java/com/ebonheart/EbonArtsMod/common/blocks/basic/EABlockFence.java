...
public class EABlockFence extends Block {
    ...
    public boolean canConnectTo(IBlockAccess worldIn, BlockPos pos)
    {
        ...
        return block == Blocks.barrier ? false : 
        	(
        			(!(block instanceof BlockFence || block instanceof EABlockFence) || block.getMaterial() != this.blockMaterial) 
    ...
    public boolean canPlaceTorchOnTop(IBlockAccess world, BlockPos pos)
    {
        ...
        {
            return this instanceof EABlockFence;
        }
    }
}
