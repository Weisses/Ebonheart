...
public class ItemInfernalArmor extends ItemArmor {
	...
	public ItemInfernalArmor(String unlocalizedName, int renderIndexIn)
	{
		super(MaterialHelper.SCALEMAIL, renderIndexIn, renderIndexIn);
	...
	{
		toolTip.add(ChatFormatting.DARK_AQUA + "Fire resistance???");
		toolTip.add(ChatFormatting.DARK_AQUA + "Maaayyybbbbeeeeee?????");
		toolTip.add(" ");
		toolTip.add(ChatFormatting.WHITE + " ");
		toolTip.add(ChatFormatting.GREEN + "-");
		toolTip.add(ChatFormatting.GREEN + "-");
