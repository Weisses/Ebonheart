...
public class EABlockWall extends EABlockFence {
	...
	public final boolean canConnectTo(final IBlockAccess blockAccess, final BlockPos pos) 
	{
		...
		if (block instanceof EABlockWall || block instanceof com.ebonheart.EbonArtsMod.common.blocks.basic.EABlockFenceGate) 
		{
			return true;
		}
	...
	private boolean canConnectUp(final IBlockAccess blockAccess, final BlockPos pos) 
	{
		...
		return upBlock instanceof net.minecraft.block.BlockTorch || upBlock instanceof com.ebonheart.EbonArtsMod.common.blocks.basic.torches.EABlockTorchArcanite
				 ||
