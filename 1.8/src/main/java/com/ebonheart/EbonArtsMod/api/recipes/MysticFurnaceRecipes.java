package com.ebonheart.EbonArtsMod.api.recipes;
...
public class MysticFurnaceRecipes {

	private static final MysticFurnaceRecipes smeltingBase = new MysticFurnaceRecipes();
    ...
    /**
     * Returns an instance of MysticFurnaceRecipes.
     */
    public static MysticFurnaceRecipes instance()
    {
        return smeltingBase;
    }

    private MysticFurnaceRecipes()
    {
