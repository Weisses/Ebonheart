...
public class TileColorAtrium extends TileEntityLockable implements IUpdatePlayerListBox, ISidedInventory {
	    ...
	    {
	        return this.hasCustomName() ? this.furnaceCustomName : "container.color_atrium";
	    }
