...
public class BlockOreNecrocite extends Block {
	
	public BlockOreNecrocite(int harvestlevel, float hardness) 
	{
		super(Material.rock);
		BlockHelperOLDOLDOLD.setBlockName(this, "ore/necrocite_ore");
