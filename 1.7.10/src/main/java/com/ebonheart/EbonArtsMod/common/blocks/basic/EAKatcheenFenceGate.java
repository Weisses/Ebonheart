...
public class EAKatcheenFenceGate extends BlockFenceGate {
	
	public static Block fenceBlockEA;
	public EAKatcheenFenceGate(String unlocalizedName, Block US) 
	{
		super();
    ...
    {
        return InitBlocksEA.katcheen_block.getBlockTextureFromSide(p_149691_1_);
    }
