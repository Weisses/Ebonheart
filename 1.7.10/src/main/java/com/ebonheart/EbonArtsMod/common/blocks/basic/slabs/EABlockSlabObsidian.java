...
public abstract class EABlockSlabObsidian extends BlockSlab {
	...
	public EABlockSlabObsidian(boolean p_i45410_1_) 
	{
	 ...
	 @SideOnly(Side.CLIENT)
	    public IIcon getIcon(int p_149691_1_, int p_149691_2_)
	    {
		 ...
		 return InitBlocksEA.obsidian_block.getBlockTextureFromSide(p_149691_1_);
	     //   int k = p_149691_2_ & 7;
	    ...
	    {
			return new ItemStack(InitBlocksEA.obsidian_block);
