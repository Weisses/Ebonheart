package com.ebonheart.ebonarts.blocks;
...
public class EbonAlter extends Block implements ITileEntityProvider {

	public EbonAlter(Material materialIn) {
		super(materialIn);
		...
		if(stack != null)
		{
			if (stack.getItem() instanceof ItemCoordinateCache)
			{
				if(stack.getItem().hasEffect(stack)) {
					TileEntityEbonAlter tect = (TileEntityEbonAlter) worldIn.getTileEntity(pos);
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		...
		return new TileEntityEbonAlter();
	}
