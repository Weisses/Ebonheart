...
public class TileEntityFurnaceEA extends TileEntityLockable implements IUpdatePlayerListBox, ISidedInventory
{
   ...
   // private static final String __OBFID = "CL_00000357";
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = MysticFurnaceRecipes.instance().getSmeltingResult(this.furnaceItemStacks[0]);
    ...
    public static int getItemBurnTime(ItemStack p_145952_0_)
    {
        ...
        else
        {
            ...
            //if (item == EbonArtsItems.item_arcanite) return 2400;
