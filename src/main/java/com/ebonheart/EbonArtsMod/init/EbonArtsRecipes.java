...
public class EbonArtsRecipes {
	...
	{
		GameRegistry.addShapedRecipe(new ItemStack(EbonArtsBlocks.arcanite_block), new Object[]{"MMM", "MMM", "MMM", 'M', EbonArtsItems.item_arcanite});
		GameRegistry.addShapedRecipe(new ItemStack(EbonArtsItems.item_arcanite, 9), new Object[]{"B", 'B', EbonArtsBlocks.arcanite_block});
