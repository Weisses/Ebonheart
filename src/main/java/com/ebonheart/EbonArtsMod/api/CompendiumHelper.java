...
public interface CompendiumHelper {

	/**
	 * Adds an entry to the compendium.
	 *
	 * @param entryItem    The item that the compendium entry describes.  Can be an item, a block, an entity, or a potion part (incl shape/component/or modifier).
