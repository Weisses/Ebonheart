 ...
 */
public final class OmnibusRecipeMappings {
	 ...
	 */
	public static void map(ItemStack stack, OmnibusEntry entry, int page, boolean force) {
	...
	public static void map(ItemStack stack, OmnibusEntry entry, int page) {
	...
	public static class EntryData {
		...
		public final OmnibusEntry entry;
		public final int page;

		public EntryData(OmnibusEntry entry, int page) {
			this.entry = entry;
			this.page = page;
		}
