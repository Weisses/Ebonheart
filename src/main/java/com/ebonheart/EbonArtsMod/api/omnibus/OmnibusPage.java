...
public abstract class OmnibusPage {

	public String unlocalizedName;
	public boolean skipRegistry;

	public OmnibusPage(String unlocalizedName) {
	...
	public abstract void renderScreen(IGuiOmnibusEntry gui, int mx, int my);
	 ...
	 */
	@SideOnly(Side.CLIENT)
	public void updateScreen(IGuiOmnibusEntry gui) {
		updateScreen();
	}
	 ...
	 */
	@SideOnly(Side.CLIENT)
	public void onOpened(IGuiOmnibusEntry gui) {
		// NO-OP
	}
	 ...
	 */
	@SideOnly(Side.CLIENT)
	public void onClosed(IGuiOmnibusEntry gui) {
		// NO-OP
	}
	 ...
	 */
	@SideOnly(Side.CLIENT)
	public void onActionPerformed(IGuiOmnibusEntry gui, GuiButton button) {
		// NO-OP
	}
	...
	/**
	 * Called when {@link OmnibusEntry#setLexiconPages(OmnibusPage...)} is called.
	 */
	public void onPageAdded(OmnibusEntry entry, int index) {
		// NO-OP
	}
	...
	public OmnibusPage setSkipRegistry() {
		skipRegistry = true;
		return this;
	}
}
