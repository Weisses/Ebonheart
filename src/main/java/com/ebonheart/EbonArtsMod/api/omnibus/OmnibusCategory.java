...
public class OmnibusCategory implements Comparable<OmnibusCategory> {

	private static int count = 0;

	public final String unlocalizedName;
	public final List<OmnibusEntry> entries = new ArrayList<OmnibusEntry>();
	 ...
	 */
	public OmnibusCategory(String unlocalizedName) {
	 ...
	 * by insertion order.
	 */
	public OmnibusCategory setPriority(int priority) {
	...
	public OmnibusCategory setIcon(ResourceLocation icon) {
		this.icon = icon;
		return this;
	}
	...
	@Override
	public int compareTo(OmnibusCategory category) {
