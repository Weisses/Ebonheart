...
public class BlockLogEA extends BlockRotatedPillarEA {

	public static final PropertyEnum LOG_AXIS = PropertyEnum.create("axis", BlockLogEA.EnumAxis.class);
    //private static final String __OBFID = "CL_00000266";
    
	public BlockLogEA(Material materialIn) {
		super(materialIn);
    ...
    {
        return super.onBlockPlaced(worldIn, pos, facing, hitX, hitY, hitZ, meta, placer).withProperty(LOG_AXIS, BlockLogEA.EnumAxis.fromFacingAxis(facing.getAxis()));
    }
    ...
    public static enum EnumAxis implements IStringSerializable
    {
        ...
        public static BlockLogEA.EnumAxis fromFacingAxis(EnumFacing.Axis axis)
        {
            switch (BlockLogEA.SwitchAxis.AXIS_LOOKUP[axis.ordinal()])
            {
                case 1:
                    return X;
                case 2:
