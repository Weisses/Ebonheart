...
public class GuiOmnibusChallenge extends GuiOmnibus implements IParented {
	...
	public GuiOmnibusChallenge() {
		parent = new GuiOmnibusChallengesList();
	}

	public GuiOmnibusChallenge(GuiOmnibus parent, Challenge challenge) {
		this.parent = parent;
	...
	public GuiOmnibus copy() {
		return new GuiOmnibusChallenge(parent, challenge);
	}
