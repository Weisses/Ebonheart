...
public class GuiButtonBookmark extends GuiButtonLexicon {
	...
	public GuiButtonBookmark(int par1, int par2, int par3, GuiOmnibus gui, String str) {
	...
	public void drawButton(Minecraft mc, int par2, int par3) {
		...
		if(displayString.equals("+"))
			...
			tooltip.add(String.format(StatCollector.translateToLocal("botaniamisc.bookmark"), id - GuiOmnibus.BOOKMARK_START + 1));
