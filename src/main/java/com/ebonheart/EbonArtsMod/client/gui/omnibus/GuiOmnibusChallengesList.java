...
import com.ebonheart.EbonArtsMod.client.gui.omnibus.button.GuiButtonChallengeIcon;
...
public class GuiOmnibusChallengesList extends GuiOmnibus implements IParented {

	GuiOmnibus parent;
	GuiButton backButton;

	public GuiOmnibusChallengesList() {
	...
	protected void actionPerformed(GuiButton par1GuiButton) {
		if(par1GuiButton.id >= BOOKMARK_START)
			...
			mc.displayGuiScreen(new GuiOmnibusChallenge(this, cbutton.challenge));
	...
	public GuiOmnibus copy() {
		return new GuiOmnibusChallengesList();
	}
