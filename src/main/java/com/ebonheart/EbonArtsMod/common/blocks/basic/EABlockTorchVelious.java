...
public class EABlockTorchVelious extends Block {
	    ...
	    public void randomDisplayTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
	    {
	        ...
	        {
	            EnumFacing enumfacing1 = enumfacing.getOpposite();
	            worldIn.spawnParticle(EnumParticleTypes.SPELL_MOB_AMBIENT, d0 + d4 * (double)enumfacing1.getFrontOffsetX(), d1 + d3, d2 + d4 * (double)enumfacing1.getFrontOffsetZ(), -1.0D, -5.0D, 1.0D, new int[0]);
	            worldIn.spawnParticle(EnumParticleTypes.REDSTONE, d0 + d4 * (double)enumfacing1.getFrontOffsetX(), d1 + d3, d2 + d4 * (double)enumfacing1.getFrontOffsetZ(), -1.1D, -5.8D, 9.0D, new int[0]);
	        }
	        else
	        {
	            worldIn.spawnParticle(EnumParticleTypes.SPELL_MOB_AMBIENT, d0, d1, d2, -1.0D, -5.0D, 1.0D, new int[0]);
	            worldIn.spawnParticle(EnumParticleTypes.REDSTONE, d0, d1, d2, -1.1D, -5.8D, 9.0D, new int[0]);
	        }
	    }
	    ...
	    public int getMetaFromState(IBlockState state)
	    {
	        ...
	        switch (EABlockTorchVelious.SwitchEnumFacing.FACING_LOOKUP[((EnumFacing)state.getValue(FACING)).ordinal()])
	        {
	            case 1:
	                i = b0 | 1;
	                break;
