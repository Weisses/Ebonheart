...
public class BlockStairsMetaEA extends EABlockStairs {

	//public BlockStairsMetaEA(IBlockState modelState) {
	//	super(modelState);
...
public static final PropertyEnum TYPE = PropertyEnum.create("type", EABlockMeta.EnumType.class);
	...
	public BlockStairsMetaEA(IBlockState modelState, String unlocalizedName, Material materialIn) 
	{
		super(modelState);
