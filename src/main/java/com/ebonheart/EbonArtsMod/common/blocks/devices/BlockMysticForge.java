 ...
 * 
 */
public class BlockMysticForge {

    private static HashMap<String, BlockMysticForge> dimensionalMap = new HashMap<String, BlockMysticForge>();

    private HashMap<Character, BlockState> comparisonMap = new HashMap<Character, BlockState>();
    private ArrayList<Layer> layers = new ArrayList<Layer>();

    private BlockMysticForge(IPatternComponent... components) {
     ...
     * @return
     */
    public static BlockMysticForge createPattern(String id, IPatternComponent... components) {
        ...
        BlockMysticForge pattern = new BlockMysticForge(components);
     ...
     * @return
     */
    public static BlockMysticForge updatePattern(String id, IPatternComponent... components) {
        if (components.length == 0)
            return null;
