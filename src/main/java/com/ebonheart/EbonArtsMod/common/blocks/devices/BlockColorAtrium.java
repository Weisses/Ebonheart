...
public class BlockColorAtrium extends BlockContainer {

	//protected BlockColorAtrium(Material materialIn) {
	//	super(materialIn);
    ...
    public BlockColorAtrium(boolean isBurning)
    {
        super(Material.rock);
    ...
    public void randomDisplayTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
    {
        if (this.isBurning)
        {
            ...
            switch (BlockColorAtrium.SwitchEnumFacing.FACING_LOOKUP[enumfacing.ordinal()])
            {
                case 1:
