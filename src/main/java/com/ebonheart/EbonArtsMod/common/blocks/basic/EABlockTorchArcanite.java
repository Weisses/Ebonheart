...
public class EABlockTorchArcanite extends Block{
	    ...
	    public void randomDisplayTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
	    {
	        ...
	        if (enumfacing.getAxis().isHorizontal())
	        {
	            ...
	            worldIn.spawnParticle(EnumParticleTypes.REDSTONE, d0 + d4 * (double)enumfacing1.getFrontOffsetX(), d1 + d3, d2 + d4 * (double)enumfacing1.getFrontOffsetZ(), 0.0D, 5.0D, 2.0D, new int[0]);
	        ...
	        else
	        {
	            ...
	            worldIn.spawnParticle(EnumParticleTypes.REDSTONE, d0, d1, d2, 0.0D, 5.0D, 2.0D, new int[0]);
	    ...
	    public int getMetaFromState(IBlockState state)
	    {
	        ...
	        switch (EABlockTorchArcanite.SwitchEnumFacing.FACING_LOOKUP[((EnumFacing)state.getValue(FACING)).ordinal()])
	        {
	            case 1:
	                i = b0 | 1;
	                break;
