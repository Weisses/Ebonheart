...
public class PageBrew extends PageRecipe implements ITwoNamedPage {
	...
	public void renderRecipe(IGuiOmnibusEntry gui, int mx, int my) {
		...
		if(book != null && book.getItem() instanceof IOmnibus && ((IOmnibus) book.getItem()).isKnowledgeUnlocked(book, EbonArtsAPI.elvenKnowledge)) {
	...
	public void renderItemAtLinePos(IGuiOmnibusEntry gui, int offset, int pos, int yPos, ItemStack stack) {
