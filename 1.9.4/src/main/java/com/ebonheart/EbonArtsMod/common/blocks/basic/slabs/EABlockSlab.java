...
public abstract class EABlockSlab extends BlockSlab
{
    ...
    {
        return new ItemStack(InitBlocksEA.draconium_slab, 1, ((EABlockSlab.EnumType)state.getValue(VARIANT)).getMetadata());
    }
    ...
    public void getSubBlocks(Item itemIn, CreativeTabs tab, List<ItemStack> list)
    {
        ...
        {
            for (EABlockSlab.EnumType EABlockSlabDraconium$enumtype : EABlockSlab.EnumType.values())
            {
    ...
    public static enum EnumType implements IStringSerializable
    {
        ...
        static
        {
            for (EABlockSlab.EnumType EABlockSlabDraconium$enumtype : values())
            {
