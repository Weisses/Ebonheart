...
public class ItemBlockSlabVelious extends ItemSlab {
    /**
     ...
     */
    public ItemBlockSlabVelious(final Block block, final BlockHalfSlabVelious slab, final BlockDoubleSlabVelious doubleSlab, final Boolean stacked) 
    {
