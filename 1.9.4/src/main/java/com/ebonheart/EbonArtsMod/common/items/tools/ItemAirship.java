...
public class ItemAirship extends Item {
	    ...
	    private final EntityAirship.Type type;

	    public ItemAirship(EntityAirship.Type typeIn)
	    {
	        this.type = typeIn;
	        this.maxStackSize = 1;
	    ...
	    public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand)
	    {
	        ...
	        else
	        {
	            ...
	            else
	            {
	                ...
	                EntityAirship EntityAirship = new EntityAirship(worldIn, raytraceresult.hitVec.xCoord, flag1 ? raytraceresult.hitVec.yCoord - 0.12D : raytraceresult.hitVec.yCoord, raytraceresult.hitVec.zCoord);
	                EntityAirship.setBoatType(this.type);
	                EntityAirship.rotationYaw = playerIn.rotationYaw;

	                if (!worldIn.getCollisionBoxes(EntityAirship, EntityAirship.getEntityBoundingBox().expandXyz(-0.1D)).isEmpty())
	                {
